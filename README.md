...
| 10 | [NEGOCIO_SAAS.md](./Documentacion/NEGOCIO_SAAS.md) | Modelo de negocio: planes, precios, medios de pago, mercado objetivo y adquisición de clientes |
| 11 | [Servidor.md](./Servidor_Documentacion/Servidor.md) | Hardware, instalación y administración del servidor |
